...
export async function stake() {
    ...
    console.log(`Alice's balance after unstake 700K SPO ${balance_alice_2.toString()}`);
    ...
    console.log(`Alice's balance after unstake 800K SPO ${balance_alice_3.toString()}`);
}
